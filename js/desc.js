            ...
            success:function(arr){
                ...
                for(var i = 0; i < arr.length; i++){
                   ...
                   if(goodsArr[i].id == id){
                    ...
                    <div class="shoeSort fl">
                        <div class="titbar">
                            <a href="javascript:;">${goodsArr[i].brand}</a>
                            <span class="v-icon"></span>
                        </div>
                        <div class="titbarbox" >
                            <a href="javascript:;">耐克</a>
                    ...
                    <span class="fl you"> > </span>
                    <div class="ellipsis titdesc fl">${goodsArr[i].title}</div>
                </div>
                <div class="product clr">
                    <div class="proImgs fl">
                        <div class="showImgs">
                             <img src="${goodsArr[i].imgs[0]}" alt="" style="width: 400px; height: 400px;"> 
                            <div class="shadow">+</div>
                        </div>
                        <div class="showDetails">
                            <img src="${goodsArr[i].imgs[0]}" alt="" > 
                        </div>
                        <div class="detailBox">
                            <a href="javascript:;" class="scrollBtn scrollleft">
                                <span class="iconfont icon-zuohuaxiangzuo"></span>
